...
set_property -dict { PACKAGE_PIN E4    IOSTANDARD LVCMOS33 } [get_ports { an2 }]
set_property -dict { PACKAGE_PIN F3    IOSTANDARD LVCMOS33 } [get_ports { an3 }]
...
#Led
set_property -dict {PACKAGE_PIN G1 IOSTANDARD LVCMOS33} [get_ports {din1[0]}]
set_property -dict {PACKAGE_PIN G2 IOSTANDARD LVCMOS33} [get_ports {din1[1]}]
set_property -dict {PACKAGE_PIN F1 IOSTANDARD LVCMOS33} [get_ports {din1[2]}]
set_property -dict {PACKAGE_PIN F2 IOSTANDARD LVCMOS33} [get_ports {din1[3]}]
